	...
	try {
		...
		if(request.getParameter("department") != null)
		{
			...
			else if(method.equals("insert"))
			{
				...
				preState.setString(1, request.getParameter("insertFname"));
				preState.setString(2, request.getParameter("insertMinit"));
				preState.setString(3, request.getParameter("insertLname"));
				preState.setString(4, request.getParameter("insertSSn"));
				preState.setString(5, request.getParameter("insertBdate"));
				preState.setString(6, request.getParameter("insertAddress"));
				preState.setString(7, request.getParameter("insertSex"));
				preState.setString(8, request.getParameter("insertSalary"));
				preState.setString(9, request.getParameter("insertSuper_ssn"));
				preState.setString(10, request.getParameter("insertDno"));
				preState.executeUpdate();
			}
			// 검색
			else if(method.equals("search"))
			{
				...
				sql = "Select concat(e1.Fname, e1.Lname) as Name, e1.ssn, ";
...
<p> 새로운 직원 추가하기 </p>
Fname : <input type="text" name="insertFname">
Minit : <input type="text" name="insertMinit">
<br>
Lname   : <input type="text" name="insertLname">
Ssn : <input type="text" name="insertSSn">
<br>
Bdate : <input type="text" name="insertBdate">
Address : <input type="text" name="insertAddress">
<br>
Sex   : <input type="text" name="insertSex">
Salary : <input type="text" name="insertSalary">
<br>
Super_ssn : <input type="text" name="insertSuper_ssn">
Dno : <input type="text" name="insertDno">
<button type="submit" name="method" value="insert"> 추가하기 </button>
</form>
